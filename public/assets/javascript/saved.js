...
$(document).ready(function() {
    ...
    //pulling up article notes, saving notes, and deleting article notes
    ...
    function initPage() {
        ...
        $.get("/api/headlines?saved=true").then(function(data) {
            ...
            if (data && data.length) {
                ...
                //otherwise render a messge explaining we have no articles
                renderEmpty();
            }
        });
    }
    ...
    function createPanel(article) {
        //this function takes in a single json object for an article/headlin
      ...
      //we will use this when trying to figure our which article the user wants to remove or open notes for
      panel.data("_id", article._id);
      //we return the constructed panel jquey elemen
      return panel;
    }

    function renderEmpty() {
        //this function renders some html to the page expaining we dont have any articles to view
        //using a joined array of html string data because its easier to read/change than a concentrated string
        var emptyAlert = 
    ...
    function renderNotesList(data) {
        ...
        if (!data.notes.length) {
            ...
            for (var i = 0; i < data.notes.length; i++) {
                //contructs an li element to contain our noteText and a delete button
                currentNote = $([
    ...
    function handleArticleDelete() {
        //this function handles deleting articels/headines
    ...
    function handleArticleNotes() {
        ...
        $.get("/api/notes/" + currentArticle._id).then(function(data) {
            //contructing our initial HTML to add to the notes modal
            var modalText = [
    ...
    function handleNoteDelete() {
        ...
        //we started this data on the delete button when we created it
        var noteToDelete = $(this).data("_id");
        //perform a DELETE request to "/api/notes" with the id of the note were deleting as a parameter
        $.ajax({
